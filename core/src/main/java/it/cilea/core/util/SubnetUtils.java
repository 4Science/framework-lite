...
public class SubnetUtils {
    ...
    public final class SubnetInfo {
        ...
        public int low()           { return network() + 1; }
        public int high()          { return broadcast() - 1; }
    ...
    private int rangeCheck(int value, int begin, int end) {    	
        ...
        throw new IllegalArgumentException("Value out of range: [" + value + "]. The problem is probably bounded with malformed ips like this 193.205.162.82/255.255.255.255");
    }
