...
public class QueryNormalizer {
	...
	public static String getNormalizedQuery(String query) {
		String result="";
		try {
			//TODO: check if the ISO character encoding is right
			//it should be used UTF-8 but it seems not to work properly
			InputStream input = new ByteArrayInputStream(query.getBytes("ISO-8859-1"));
